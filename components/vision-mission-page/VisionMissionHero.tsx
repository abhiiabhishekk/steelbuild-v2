...
const principles = [
  {
    ...
    title: "Clear Vision",
    description:
      "Building a trusted and admired organization delivering excellence across steel products and engineering services.",
  },
  {
    icon: Target,
    title: "Purposeful Mission",
    description:
      "Serving customers through dependable quality, timely delivery, transparent communication and responsible execution.",
  },
  {
    icon: ShieldCheck,
    title: "Strong Values",
    description:
      "Operating with commitment, accountability, integrity, teamwork and continuous improvement.",
  },
];
          ...
          >
            ...
            <h1 className="mt-7 max-w-4xl text-5xl font-black leading-[0.98] tracking-[-0.055em] text-primary-blue md:text-6xl lg:text-[72px]">
              ...
              <span className="block">
                Values That Guide Every Commitment.
              </span>
            </h1>

            <p className="mt-7 max-w-2xl text-lg font-medium leading-9 text-gray-600">
              Our vision, mission and values define how Steelbuild approaches
              engineering, manufacturing, customer relationships and project
              delivery across every stage of business.
            </p>
            ...
            <div className="mt-8 flex max-w-xl items-start gap-3 rounded-[22px] border border-gray-200 bg-white p-5 shadow-[0_14px_40px_rgba(27,63,104,0.06)]">
              ...
              <p className="text-sm font-bold leading-7 text-gray-600">
                Driven by commitment and quality while creating dependable
                value for customers, employees and stakeholders.
              </p>
            </div>
          </motion.div>
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <h2 className="mt-2 text-3xl font-black leading-tight text-white">
                    Principles Supporting Sustainable Growth
                  </h2>
                </div>
              </div>

              <p className="mt-6 text-base font-medium leading-8 text-white/70">
                Steelbuild&apos;s direction is grounded in responsible
                leadership, engineering excellence, customer trust and
