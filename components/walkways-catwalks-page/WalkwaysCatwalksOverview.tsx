...
const overviewPoints = [
  {
    number: "01",
    icon: Route,
    title: "Organized Elevated Movement",
    description:
      "Industrial walkways establish clear movement routes between platforms, mezzanines, equipment and service areas.",
  },
  {
    number: "02",
    icon: Frame,
    ...
    description:
      "Walkway framing, support beams and connection members are coordinated with the surrounding steel building.",
  },
  {
    number: "03",
    icon: ShieldCheck,
    title: "Project-Specific Access Layout",
    description:
      "Walkway width, elevation, support locations and access connections are developed according to approved project requirements.",
  },
];

const walkwayFeatures = [
  {
    number: "01",
    icon: Footprints,
    title: "Steel Grating Flooring",
    description:
      "Open steel grating provides a practical elevated walking surface for industrial access.",
  },
  {
    number: "02",
    icon: Frame,
    title: "Primary Support Framing",
    description:
      "Structural beams and support members carry the approved walkway arrangement.",
  },
  {
    number: "03",
    icon: Building2,
    ...
    description:
      "Walkways connect mezzanines, platforms, equipment zones and service areas.",
  },
  {
    number: "04",
    icon: ShieldCheck,
    ...
    description:
      "Guardrails, mid rails and toe boards are coordinated along exposed edges.",
  },
];

export default function WalkwaysCatwalksOverview() {
  return (
    <section
...
>
          ...
          >
            ...
            <h2 className="mt-7 text-4xl font-black leading-tight tracking-[-0.045em] text-primary-blue md:text-5xl lg:text-[58px]">
              Elevated Access Integrated With Steel Structures
            </h2>

            <p className="mt-6 text-lg font-medium leading-8 text-gray-600">
              Industrial steel walkways and catwalks provide elevated movement
              between platforms, equipment, service areas and maintenance zones
              while remaining integrated with the structural steel building.
            </p>

            <p className="mt-5 text-base font-medium leading-8 text-gray-500">
              Walkway alignment, support framing, platform intersections and
            ...
            <div className="mt-8 flex items-start gap-4 border-l-4 border-primary-red bg-white px-6 py-5 shadow-[0_14px_40px_rgba(27,63,104,0.06)]">
              ...
              <p className="text-sm font-bold leading-7 text-primary-blue">
                Final walkway routing, support framing, grating, guardrails,
                platform connections and access arrangements are developed
                according to approved engineering drawings and site
                conditions.
              </p>
            </div>
          </motion.div>
