...
const projectInputs = [
  {
    icon: Route,
    title: "Access Route Information",
    text: "Required start and end points, walkway elevation, service areas and movement requirements",
  },
  {
    icon: Ruler,
    title: "Walkway Layout",
    text: "Available width, span, support points, equipment clearances and connection locations",
  },
  {
    icon: FileText,
    title: "Project Documents",
    text: "Approved layouts, structural drawings, site conditions and expected project timeline",
  },
];

export default function WalkwaysCatwalksCTA() {
  return (
          ...
          <div className="relative z-10 grid gap-12 px-8 py-12 md:px-12 md:py-16 lg:grid-cols-[1.06fr_0.94fr] lg:items-center lg:px-16 lg:py-20">
            ...
            <div>
              <span className="inline-flex items-center gap-2 rounded-full border border-white/15 bg-white/10 px-5 py-2.5 text-[11px] font-black uppercase tracking-[0.26em] text-white backdrop-blur-md">
                ...
                />
                Walkway & Catwalk Consultation
              </span>

              <h2 className="mt-7 max-w-4xl text-4xl font-black leading-[1.02] tracking-[-0.045em] text-white md:text-5xl lg:text-[58px]">
                Planning Industrial
                <span className="block">
                  Walkways or Catwalks?
                </span>
              </h2>

              <p className="mt-6 max-w-2xl text-base font-medium leading-8 text-white/70 md:text-lg">
                Share your elevated access routes, equipment locations,
                working levels, structural support information and project
                requirements with our team for a coordinated technical
                discussion.
              </p>
            ...
            <div className="rounded-[32px] border border-white/15 bg-white/[0.08] p-7 backdrop-blur-md md:p-8">
              ...
              <div className="mt-8 flex items-start gap-3 rounded-[22px] bg-[#102f55] p-5">
                ...
                <p className="text-sm font-black leading-7 text-white/80">
                  Final walkway width, framing, supports, grating, access
                  connections, guardrails and toe-board details are developed
                  according to approved engineering inputs and site conditions.
                </p>
              </div>
            </div>
          </div>
