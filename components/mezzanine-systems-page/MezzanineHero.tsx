...
const levelFeatures = [
  {
    ...
    description:
      "Creates an intermediate working or storage level within the available building height.",
  },
  {
    icon: Columns3,
    title: "Engineered Support System",
    description:
      "Columns and beams are configured according to the approved layout and loading requirements.",
  },
  {
    icon: ShieldCheck,
    title: "Integrated Access Planning",
    description:
      "Staircases, openings and movement areas are coordinated with the mezzanine arrangement.",
  },
];
...
const quickHighlights = [
  {
    icon: Layers3,
    title: "Vertical Utilization",
    text: "Additional floor area within existing height",
  },
  {
    icon: Ruler,
    title: "Custom Configuration",
    text: "Grid and level planned for intended use",
  },
  {
    icon: Warehouse,
    title: "Flexible Applications",
    text: "Storage, production and workspace requirements",
  },
];

export default function MezzanineHero() {
  return (
    <section className="relative isolate overflow-hidden bg-white pb-20 pt-28 lg:pb-28 lg:pt-36">
      ...
      <Container>
        ...
        <div className="relative z-10 mt-12 grid gap-14 lg:grid-cols-[0.94fr_1.06fr] lg:items-center">
          {/* Left content */}
          ...
          >
            ...
            <h1 className="mt-7 max-w-4xl text-5xl font-black leading-[0.98] tracking-[-0.055em] text-primary-blue md:text-6xl lg:text-[72px]">
              Add More Space.
              <span className="block">Build Within Height.</span>
            </h1>

            <p className="mt-7 max-w-2xl text-lg font-medium leading-9 text-gray-600">
              Steelbuild Infra Projects Limited delivers engineered mezzanine
              systems designed to create additional usable floor area for
              storage, production, offices and operational requirements.
            </p>

            <div className="mt-9 flex flex-col gap-4 sm:flex-row sm:flex-wrap">
              <Link
                href="#mezzanine-overview"
            ...
            <div className="mt-8 flex max-w-xl items-start gap-4 rounded-[22px] border border-gray-200 bg-white p-5 shadow-[0_14px_40px_rgba(27,63,104,0.07)]">
              ...
              <p className="pt-0.5 text-sm font-bold leading-7 text-gray-600">
                Final framing, floor loading, access and connection details are
                developed according to approved project requirements.
              </p>
            </div>
          </motion.div>

          {/* Right mezzanine visual */}
            ...
            <div className="relative z-10">
              <div className="flex items-start justify-between gap-6">
                <div>
                  ...
                  <h2 className="mt-3 max-w-xl text-3xl font-black leading-tight text-white">
                    One Building Height. Multiple Usable Levels.
                  </h2>
                </div>
              ...
              <div className="relative mt-9 overflow-hidden rounded-[30px] border border-white/12 bg-[#102f55]/70 px-6 py-8 md:px-8">
                ...
                <div className="relative z-10">
                  ...
                  <div className="grid grid-cols-[56px_1fr] items-center gap-5">
                    <div className="flex h-14 w-14 items-center justify-center rounded-2xl bg-white/10 text-primary-red">
                      <Boxes size={24} />
                    </div>
                  ...
                  <div className="relative my-6 h-5">
                    <div className="absolute inset-x-0 top-1/2 h-[7px] -translate-y-1/2 rounded-full bg-white" />

                    <div className="absolute left-[10%] top-1/2 h-14 w-2 -translate-y-1/2 rounded-full bg-primary-red" />

                    <div className="absolute left-1/2 top-1/2 h-14 w-2 -translate-x-1/2 -translate-y-1/2 rounded-full bg-primary-red" />

                    <div className="absolute right-[10%] top-1/2 h-14 w-2 -translate-y-1/2 rounded-full bg-primary-red" />
                  </div>

                  {/* Ground level */}

                  <div className="mt-7 grid grid-cols-[56px_1fr] items-center gap-5">
                    <div className="flex h-14 w-14 items-center justify-center rounded-2xl bg-white/10 text-primary-red">
                      <Warehouse size={24} />
                    </div>
                    ...
                    <div>
                      ...
                      <p className="mt-1 text-lg font-black text-white">
                        Operational Space Retained Below
                      </p>
                    </div>
                  </div>
                </div>
              ...
              {/* Three concise features */}

              <div className="mt-6 space-y-4">
                {levelFeatures.map((item, index) => {
