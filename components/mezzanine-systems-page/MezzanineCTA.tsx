...
const projectInputs = [
  {
    ...
    text: "Floor area, clear height and proposed mezzanine footprint",
  },
  {
    icon: Layers3,
    title: "Intended Usage",
    text: "Storage, office, production or operational support requirement",
  },
  {
    icon: FileText,
    title: "Project Details",
    text: "Approved loading, site conditions, access and expected timeline",
  },
];

export default function MezzanineCTA() {
  return (
          ...
          <div className="relative z-10 grid gap-12 px-8 py-12 md:px-12 md:py-16 lg:grid-cols-[1.06fr_0.94fr] lg:items-center lg:px-16 lg:py-20">
            ...
            <div>
              ...
              <p className="mt-6 max-w-2xl text-base font-medium leading-8 text-white/70 md:text-lg">
                Share your available floor area, building height, intended
                usage, approved loading and access requirements with our team
            ...
            <div className="rounded-[32px] border border-white/15 bg-white/[0.08] p-7 backdrop-blur-md md:p-8">
              ...
              <div className="mt-8 flex items-start gap-3 rounded-[22px] bg-[#102f55] p-5">
                ...
                <p className="text-sm font-black leading-7 text-white/80">
                  Final framing, connections, floor support and access systems
                  are developed according to approved engineering inputs and
                  site conditions.
                </p>
              </div>
            </div>
