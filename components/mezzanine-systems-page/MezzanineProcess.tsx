...
const processSteps = [
  {
    ...
    description:
      "Understanding intended usage, available height, floor area, loading, access and existing site conditions.",
  },
  {
    number: "02",
    icon: Ruler,
    ...
    description:
      "Planning the mezzanine footprint, column grid, access points and clear operational areas.",
  },
  {
    number: "03",
    icon: Layers3,
    ...
    description:
      "Developing columns, beams, floor-support systems, connections and coordinated project drawings.",
  },
  {
    number: "04",
    icon: Factory,
  ...
  },
  {
    ...
    description:
      "Dispatching components in sequence and installing the approved mezzanine framing and access systems.",
  },
  {
    number: "06",
    icon: CheckCircle2,
    ...
    description:
      "Completing final checks, closing observations and handing over the approved mezzanine scope.",
  },
];

export default function MezzanineProcess() {
  return (
      ...
      <Container>
        ...
        >
          <span className="inline-flex items-center gap-2 rounded-full bg-primary-red/10 px-6 py-2 text-xs font-black uppercase tracking-[0.3em] text-primary-red">
            <Wrench size={15} />
            Mezzanine Project Process
          </span>

          <h2 className="mt-7 text-4xl font-black leading-tight tracking-[-0.045em] text-primary-blue md:text-5xl lg:text-[58px]">
            From Space Planning to Final Mezzanine Handover
          </h2>

          <p className="mx-auto mt-6 max-w-3xl text-lg font-medium leading-8 text-gray-600">
            Mezzanine delivery requires coordinated planning, structural
            engineering, fabrication and site installation according to the
        ...
        <div className="relative z-10 mt-20 hidden lg:block">
          <div className="absolute left-[7%] right-[7%] top-[44px] h-[2px] bg-gradient-to-r from-primary-red via-primary-blue/30 to-primary-red" />
          ...
          <div className="relative z-10 flex flex-col gap-5 md:flex-row md:items-center">
            ...
            <div>
              ...
              <p className="mt-2 text-sm font-medium leading-7 text-white/70">
                Final member sizes, connections, access systems, floor support
                and installation details are developed according to the approved
                design, intended usage and site conditions.
              </p>
            </div>
          </div>
        </motion.div>
