...
const highlights = [
  {
    ...
    description:
      "Structural systems engineered for project requirements, performance and material efficiency.",
  },
  {
    icon: Factory,
    title: "Controlled Manufacturing",
    description:
      "Precision-fabricated building components produced through disciplined manufacturing systems.",
  },
  {
    icon: Clock3,
    title: "Faster Project Delivery",
    description:
      "Coordinated design, production and erection supporting efficient construction schedules.",
  },
];
  ...
  and large-scale steel infrastructure projects.
            ...
            <div className="mt-8 flex max-w-xl items-start gap-4 rounded-[22px] border border-gray-200 bg-white p-5 shadow-[0_14px_40px_rgba(27,63,104,0.07)]">
              ...
              <p className="pt-0.5 text-sm font-bold leading-7 text-gray-600">
                Integrated engineering, manufacturing and project execution
                supporting dependable Pre-Engineered Building delivery.
              </p>
            </div>
          </motion.div>
            ...
            <div className="relative z-10">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <h2 className="mt-2 text-3xl font-black leading-tight text-white">
                    Designed Around Project Performance
                  </h2>
                </div>
              </div>

              <p className="mt-6 text-base font-medium leading-8 text-white/70">
                Every Pre-Engineered Building is developed through coordinated
                structural design, fabrication planning, quality control and
              ...
              <div className="mt-7 flex items-start gap-3 rounded-[22px] border border-white/10 bg-[#102f55] p-5">
                ...
                <p className="text-sm font-black leading-7 text-white/80">
                  Driven by Commitment and Quality across engineering,
