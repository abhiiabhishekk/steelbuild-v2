          ...
          <div className="relative z-10 grid gap-12 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
            <div>
              ...
              <p className="mt-6 max-w-2xl text-base font-medium leading-8 text-white/70">
                Schedule a meeting with our engineering and business
                development teams to discuss Pre-Engineered Building
                solutions, manufacturing capabilities and upcoming industrial
                projects.
              </p>
              ...
              <div className="mt-9 flex flex-col gap-4 sm:flex-row sm:flex-wrap">
                <Link
                  href="/contact"
                  className="group inline-flex min-h-[58px] items-center justify-center gap-3 rounded-2xl bg-primary-red px-8 py-4 font-black !text-white shadow-[0_18px_42px_rgba(194,17,25,0.3)] transition-all duration-300 hover:-translate-y-1 hover:bg-red-700 hover:!text-white"
                >
                  Request a Meeting
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="mt-2 text-sm font-medium leading-7 text-white/60">
                      Connect with our team before or during the exhibition for
                      a focused project discussion.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="rounded-[26px] border border-white/10 bg-white/[0.08] p-6 backdrop-blur-md">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="mt-2 text-sm font-medium leading-7 text-white/60">
                      Discuss engineering, manufacturing, project execution and
                      technical-commercial requirements with experienced
                      professionals.
                    </p>
                  </div>
                </div>
