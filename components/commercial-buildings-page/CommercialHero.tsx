...
const commercialHighlights = [
  {
    ...
    description:
      "Structural layouts coordinated around usable floor areas, circulation, access and functional requirements.",
  },
  {
    icon: Layers3,
    title: "Integrated Building Systems",
    description:
      "Structural framing, floors, roofing and cladding planned as one coordinated commercial building solution.",
  },
  {
    icon: ShieldCheck,
    title: "Reliable Project Delivery",
    description:
      "Engineering, fabrication and site execution developed according to approved project requirements.",
  },
];
...
const quickHighlights = [
  {
    ...
    text: "Flexible commercial space planning",
  },
  {
    icon: Store,
    title: "Multiple Uses",
    text: "Retail, office and mixed-use facilities",
  },
  {
    icon: ShieldCheck,
    title: "Integrated Delivery",
    text: "Engineering through execution",
  },
];
        ...
        <div className="relative z-10 mt-12 grid gap-12 lg:grid-cols-[1.03fr_0.97fr] lg:items-center">
          ...
          >
            <span className="inline-flex items-center gap-3 rounded-full bg-primary-red/10 px-5 py-2.5 text-[11px] font-black uppercase tracking-[0.3em] text-primary-red">
              <Sparkles size={16} />
              Commercial Steel Building Solutions
            </span>
            ...
            <p className="mt-7 max-w-2xl text-lg font-medium leading-9 text-gray-600">
              Steelbuild Infra Projects Limited delivers commercial steel
              buildings planned around usable space, circulation, access,
              structural performance and future business requirements.
            </p>
            ...
            <div className="mt-8 flex max-w-xl items-start gap-4 rounded-[22px] border border-gray-200 bg-white p-5 shadow-[0_14px_40px_rgba(27,63,104,0.07)]">
              ...
              <p className="pt-0.5 text-sm font-bold leading-7 text-gray-600">
                Structural planning coordinated around functional layouts,
                building access and approved architectural requirements.
              </p>
            </div>
          </motion.div>
            ...
            <div className="relative z-10">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <h2 className="mt-2 text-3xl font-black leading-tight text-white">
                    Built Around Function and Experience
                  </h2>
                </div>
              </div>

              <p className="mt-6 text-base font-medium leading-8 text-white/70">
                Commercial steel buildings combine structural efficiency,
                adaptable floor planning and coordinated building systems
                within one modern facility.
              </p>
              ...
              <div className="mt-7 flex items-start gap-3 rounded-[22px] border border-white/10 bg-[#102f55] p-5">
                ...
                <p className="text-sm font-black leading-7 text-white/80">
                  Suitable for offices, retail spaces, business centres,
                  showrooms and mixed-use commercial facilities.
                </p>
              </div>
            </div>
          </motion.div>
