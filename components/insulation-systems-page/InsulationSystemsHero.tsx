    ...
    <div className="flex items-start gap-4">
      ...
      <div className="min-w-0">
        ...
        <p className="mt-2 text-sm font-black leading-6 text-primary-blue md:text-base">
          Insulation blankets or boards, vapour barriers, support systems,
          spacers, external roofing and wall cladding work together to improve
          thermal performance without forming a sandwich panel.
        </p>
      </div>
    </div>
  </motion.div>
