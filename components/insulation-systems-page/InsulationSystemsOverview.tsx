      ...
      <Container>
        <div className="relative z-10 grid gap-12 xl:grid-cols-[0.95fr_1.05fr] xl:items-center xl:gap-14">
              ...
              <div className="flex items-start gap-3.5 sm:gap-4">
                ...
                <div className="min-w-0">
                  ...
                  <p className="mt-1.5 text-[14px] font-black leading-[1.45] tracking-[-0.01em] text-primary-blue sm:mt-2 sm:text-base sm:leading-6">
                    Insulation blankets or boards, vapour barriers, spacers,
                    support systems, roofing sheets and wall cladding work
                    together as one coordinated thermal-envelope assembly
                    without forming a sandwich panel.
                  </p>
                </div>
              </div>
            </motion.div>
          ...
          >
            ...
            <h2 className="mt-6 text-[36px] font-black leading-[1.06] tracking-[-0.04em] text-primary-blue sm:mt-7 sm:text-4xl md:text-5xl lg:text-[56px]">
