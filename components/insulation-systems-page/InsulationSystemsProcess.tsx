...
const processSteps = [
  {
    number: "01",
    title: "Thermal Requirement Review",
    description:
  ...
  {
    number: "02",
    title: "Insulation System Engineering",
    description:
...
export default function InsulationSystemsProcess() {
  return (
      ...
      <Container>
        ...
        >
          ...
          <p className="mx-auto mt-6 max-w-3xl text-lg font-medium leading-8 text-gray-600">
            Every insulation project follows a coordinated process covering
            thermal assessment, material selection, vapour control, roof and
            wall integration, installation and final inspection.
          </p>
        </motion.div>
  ...
  <div className="relative z-10 flex flex-col gap-5 md:flex-row md:items-center">
    ...
    <div>
      ...
      <p className="mt-2 text-sm font-medium leading-7 text-white/70">
        Insulation material, thickness, density, vapour-control layer, spacer
        arrangement, support system, sealing method and installation sequence
        are finalized according to climatic conditions, condensation risk,
        building use and approved project-performance requirements.
      </p>
    </div>
  </div>
</motion.div>
