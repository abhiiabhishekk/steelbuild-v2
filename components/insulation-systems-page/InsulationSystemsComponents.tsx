  ...
  <div className="flex items-start gap-4">
    ...
    <div className="min-w-0">
      ...
      <p className="mt-2 text-sm font-black leading-6 text-primary-blue md:text-base">
        Insulation materials, vapour barriers, spacers, support systems,
        sealants and structural framing work together to deliver thermal
        efficiency without becoming part of an insulated sandwich panel.
      </p>
    </div>
  </div>
</motion.div>
...
>
  ...
  <p className="text-sm font-bold leading-7 text-primary-blue">
    ...
    sealing method and roof or wall integration are engineered according to
    climate conditions, condensation risk, fire-performance requirements,
    acoustic performance and approved project specifications.
  </p>
</motion.div>
