...
const processSteps = [
  {
    number: "01",
    title: "Daylighting Requirement Review",
    description:
      "Building use, roof geometry, required daylight levels, internal working conditions and project specifications are reviewed.",
    icon: ClipboardCheck,
  },
  {
    number: "02",
    ...
    description:
      "Sheet type, thickness, multiwall configuration, UV protection, glazing bars, gaskets, flashings and support details are finalized.",
  ...
  },
  {
    ...
    description:
      "Polycarbonate resin is extruded into technically accurate multiwall hollow-cell daylighting sheets with controlled geometry.",
    icon: Factory,
  },
  {
    number: "04",
    ...
    description:
      "Sheet thickness, hollow-cell consistency, light transmission, UV layer, surface quality and dimensions are inspected.",
    icon: SearchCheck,
  },
  {
    number: "05",
    ...
    description:
      "Polycarbonate sheets, glazing bars, EPDM gaskets, flashings and accessories are protected and prepared for safe project delivery.",
    icon: Truck,
  },
  {
    number: "06",
    title: "Roof Integration Coordination",
    description:
      "Daylighting panels are coordinated with metal roofing, roof purlins, structural framing, flashings and drainage details.",
    icon: Layers3,
  },
  {
    number: "07",
    ...
    description:
      "Sheets, glazing profiles, gaskets, flashings, closures and fasteners are installed with approved thermal-expansion allowances.",
    icon: Wrench,
  },
  {
    number: "08",
    ...
    description:
      "Sheet alignment, joint sealing, daylight continuity, weatherproofing and roof integration are verified before handover.",
    icon: BadgeCheck,
  },
];

export default function PolycarbonateSheetsProcess() {
  return (
      ...
      <Container>
        ...
        >
          ...
          <p className="mx-auto mt-6 max-w-3xl text-lg font-medium leading-8 text-gray-600">
            Every polycarbonate daylighting project follows a coordinated
            process covering system engineering, sheet manufacturing, quality
            control, roof integration, installation and final inspection.
          </p>
        </motion.div>
          ...
          <div className="relative z-10 flex flex-col gap-5 md:flex-row md:items-center">
            ...
            <div>
              <h3 className="text-2xl font-black text-white">
                Approved Daylighting Inputs Guide Every Stage
              </h3>

              <p className="mt-2 text-sm font-medium leading-7 text-white/70">
                Sheet thickness, hollow-cell configuration, UV protection,
                light-transmission level, glazing-bar profile, EPDM gasket
                system, thermal-expansion allowance, flashing details and
