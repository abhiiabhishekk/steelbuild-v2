...
export default function HeavySteelCTA() {
  return (
          ...
          <div className="relative z-10 grid gap-12 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
            ...
            <div>
              ...
              <p className="mt-6 max-w-2xl text-base font-medium leading-8 text-white/70">
                Share your structural loads, equipment requirements, project
                location, access conditions, platform requirements and
                expected timeline with our team for a coordinated technical and
            ...
            <div className="grid gap-5">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="text-xl font-black text-white">
                      Share Structural Requirements
                    </h3>

                    <p className="mt-2 text-sm font-medium leading-7 text-white/60">
                      Provide member loads, structural spans, equipment data,
                      platform requirements, project location and execution
                      conditions.
                    </p>
                  </div>
                </div>
              ...
              <div className="rounded-[26px] border border-white/10 bg-white/[0.08] p-6 backdrop-blur-md">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="mt-2 text-sm font-medium leading-7 text-white/60">
                      Our team reviews load transfer, member sizing, stability,
                      connections, fabrication feasibility and erection
                      requirements.
                    </p>
                  </div>
                </div>
              ...
              <div className="rounded-[26px] border border-white/10 bg-white/[0.08] p-6 backdrop-blur-md">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="mt-2 text-sm font-medium leading-7 text-white/60">
                      Discuss structural complexity, equipment coordination,
                      access, logistics, erection sequencing and project
              ...
              <div className="flex items-start gap-4 rounded-[26px] border border-white/10 bg-[#0b2b50]/70 p-6">
                ...
                <div>
                  <h3 className="text-xl font-black text-white">
                    Integrated Heavy Steel Delivery
                  </h3>

                  <p className="mt-2 text-sm font-medium leading-7 text-white/60">
                    Structural engineering, detailing, fabrication, quality,
                    logistics and site erection coordinated through one
