...
const highlights = [
  {
    ...
    description:
      "Heavy-duty steel framing engineered to support demanding structural, equipment and operational loads.",
  },
  {
    icon: Factory,
    title: "Precision Fabrication",
    description:
      "Large structural members manufactured through controlled cutting, welding, drilling and finishing processes.",
  },
  {
    icon: ShieldCheck,
    title: "Reliable Performance",
    description:
      "Integrated framing and stability systems designed for long-term structural strength and dependable operation.",
  },
];

export default function HeavySteelHero() {
  return (
        ...
        <div className="relative z-10 mt-12 grid gap-12 lg:grid-cols-[1.03fr_0.97fr] lg:items-center">
          ...
          >
            <span className="inline-flex items-center gap-3 rounded-full bg-primary-red/10 px-5 py-2.5 text-[11px] font-black uppercase tracking-[0.3em] text-primary-red">
              <Sparkles size={16} />
              Heavy-Duty Structural Steel Solutions
            </span>
            ...
            <p className="mt-7 max-w-2xl text-lg font-medium leading-9 text-gray-600">
              Steelbuild Infra Projects Limited delivers heavy steel
              structures engineered for demanding industrial loads, large
              structural spans, complex operating conditions and long-term
              performance.
            </p>

            <div className="mt-9 flex flex-col gap-4 sm:flex-row sm:flex-wrap">
              <Link
                href="#heavy-steel-overview"
            ...
            <div className="mt-8 flex max-w-xl items-start gap-4 rounded-[22px] border border-gray-200 bg-white p-5 shadow-[0_14px_40px_rgba(27,63,104,0.07)]">
              ...
              <p className="pt-0.5 text-sm font-bold leading-7 text-gray-600">
                Integrated engineering, heavy structural fabrication, quality
                control and project execution for specialized steel
            ...
            <div className="relative z-10">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <p className="text-[11px] font-black uppercase tracking-[0.26em] text-primary-red">
                    Specialized Steel Engineering
                  </p>

                  <h2 className="mt-2 text-3xl font-black leading-tight text-white">
                    Structured for Demanding Performance
                  </h2>
                </div>
              </div>

              <p className="mt-6 text-base font-medium leading-8 text-white/70">
                Heavy steel structures combine high-capacity columns, deep
                beams, built-up sections, bracing and engineered connections
              ...
              <div className="mt-7 flex items-start gap-3 rounded-[22px] border border-white/10 bg-[#102f55] p-5">
                ...
                <p className="text-sm font-black leading-7 text-white/80">
                  Suitable for process plants, power facilities, equipment
                  support structures, industrial platforms and heavy
        ...
        >
          ...
          <div className="flex items-center gap-4 border-b border-gray-200 p-6 md:border-b-0 md:border-r">
            ...
            <div>
              ...
              <p className="mt-1 text-xs font-medium text-gray-500">
                Coordinated framing and stability
              </p>
            </div>
          </div>
