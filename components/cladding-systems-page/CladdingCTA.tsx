...
const projectInputs = [
  {
    ...
    text: "Wall dimensions, façade layouts, openings and building height",
  },
  {
    icon: PanelsTopLeft,
    title: "Cladding Requirements",
    text: "Preferred wall system, panel orientation, trims and accessories",
  },
  {
    icon: FileText,
    title: "Approved Project Inputs",
    text: "Drawings, specifications, site conditions and expected timeline",
  },
];

export default function CladdingCTA() {
  return (
          ...
          <div className="relative z-10 grid gap-12 px-8 py-12 md:px-12 md:py-16 lg:grid-cols-[1.06fr_0.94fr] lg:items-center lg:px-16 lg:py-20">
            ...
            <div>
              ...
              <p className="mt-6 max-w-2xl text-base font-medium leading-8 text-white/70 md:text-lg">
                Share your building elevations, wall dimensions, façade
                requirements, openings and approved project information with
                our team for a coordinated technical discussion.
              </p>
            ...
            <div className="rounded-[32px] border border-white/15 bg-white/[0.08] p-7 backdrop-blur-md md:p-8">
              ...
              <div className="mt-8 flex items-start gap-3 rounded-[22px] bg-[#102f55] p-5">
                ...
                <p className="text-sm font-black leading-7 text-white/80">
                  Final profiles, panels, trims, flashings and fixing details
                  are developed according to approved drawings, project scope
                  and site conditions.
                </p>
              </div>
            </div>
