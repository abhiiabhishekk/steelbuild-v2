...
const projectInputs = [
  {
    ...
    text: "Equipment type, position, service clearances and support requirements",
  },
  {
    icon: Ruler,
    title: "Platform Layout",
    text: "Required working area, access route, elevation and available roof space",
  },
  {
    icon: FileText,
    title: "Project Information",
    text: "Approved drawings, structural inputs, site conditions and expected timeline",
  },
];

export default function RoofPlatformsCTA() {
  return (
          ...
          <div className="relative z-10 grid gap-12 px-8 py-12 md:px-12 md:py-16 lg:grid-cols-[1.06fr_0.94fr] lg:items-center lg:px-16 lg:py-20">
            ...
            <div>
              ...
              <p className="mt-6 max-w-2xl text-base font-medium leading-8 text-white/70 md:text-lg">
                Share your rooftop equipment layout, platform requirements,
                approved structural information and site conditions with our
