  ...
  <div className="flex items-start gap-4">
    ...
    <div className="min-w-0">
      ...
      <p className="mt-2 text-sm font-black leading-6 text-primary-blue md:text-base">
        Flashings, trims, ridge caps, closures and custom accessories are
        manufactured with controlled forming, dimensional accuracy and premium
        finishing to ensure consistent project quality.
      </p>
    </div>
  </div>
</motion.div>
...
>
  ...
  <p className="mt-7 max-w-2xl text-lg font-medium leading-8 text-gray-600">
    Steelbuild Sheeting Accessories are manufactured through precision sheet
    metal processing, controlled forming, dimensional inspection and quality
    finishing to ensure dependable roof and wall integration across every
    project.
  </p>
  ...
  <div className="relative z-10 flex flex-col gap-5 md:flex-row md:items-center">
    ...
    <div>
      ...
      <p className="mt-2 text-sm font-medium leading-7 text-white/70">
        Flashing geometry, trim profiles, bend accuracy, material thickness,
        protective coatings, dimensional tolerances and finishing quality are
        maintained according to approved fabrication drawings and project
        specifications.
      </p>
    </div>
  </div>
