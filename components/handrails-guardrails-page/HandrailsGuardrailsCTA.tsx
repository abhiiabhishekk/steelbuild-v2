...
const projectInputs = [
  {
    icon: Ruler,
    title: "Railing Layout Information",
    text: "Platform edges, staircase openings, walkway routes, gate locations and exposed areas",
  },
  {
    icon: Fence,
    title: "Protection Requirements",
    text: "Top rails, mid rails, posts, toe boards, access gates and corner transitions",
  },
  {
    icon: FileText,
    title: "Project Documents",
    text: "Approved layouts, structural drawings, specifications, site conditions and project timeline",
  },
];

export default function HandrailsGuardrailsCTA() {
  return (
          ...
          <div className="relative z-10 grid gap-12 px-8 py-12 md:px-12 md:py-16 lg:grid-cols-[1.06fr_0.94fr] lg:items-center lg:px-16 lg:py-20">
            ...
            <div>
              <span className="inline-flex items-center gap-2 rounded-full border border-white/15 bg-white/10 px-5 py-2.5 text-[11px] font-black uppercase tracking-[0.26em] text-white backdrop-blur-md">
                ...
                />
                Handrail & Guardrail Consultation
              </span>
              ...
              <p className="mt-6 max-w-2xl text-base font-medium leading-8 text-white/70 md:text-lg">
                Share your platform edges, staircase openings, walkway routes,
                access-gate locations and structural information with our team
                for a coordinated technical discussion.
              </p>
            ...
            <div className="rounded-[32px] border border-white/15 bg-white/[0.08] p-7 backdrop-blur-md md:p-8">
              ...
              <div className="mt-8 flex items-start gap-3 rounded-[22px] bg-[#102f55] p-5">
                ...
                <p className="text-sm font-black leading-7 text-white/80">
                  Final rail heights, post spacing, toe boards, gates, corner
                  details and structural connections are developed according to
