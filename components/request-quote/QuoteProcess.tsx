    ...
    <section className="relative overflow-hidden bg-[#f7f9fc] py-24 lg:py-32">
      ...
      <Container>
            ...
            {process.map((item, index) => {
              ...
              return (
                ...
                >
                  ...
                  <p className="mx-auto mt-4 max-w-xs text-sm leading-7 text-gray-500">
                    {item.description}
                  </p>
                </motion.div>
              );
        ...
        <motion.div
          ...
          className="mx-auto mt-20 max-w-5xl rounded-[30px] border border-primary-blue/10 bg-white p-8 text-center shadow-[0_20px_60px_rgba(27,63,104,0.08)]"
        >
