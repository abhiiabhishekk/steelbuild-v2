  ...
  return (
    <section className="relative overflow-hidden bg-white py-24 lg:py-32">
      ...
      <Container>
        ...
        <div className="relative z-10 mt-16 grid min-w-0 gap-6 md:grid-cols-2 xl:grid-cols-3">
          {advantages.map(
            (item, index) => {
              const Icon =
                item.icon;
              ...
              return (
                <motion.article
                  ...
                  className="group relative min-w-0 overflow-hidden rounded-[28px] border border-gray-200 bg-white p-7 shadow-[0_18px_55px_rgba(27,63,104,0.07)] transition-all duration-500 hover:-translate-y-2 hover:border-primary-red/25 hover:shadow-[0_30px_80px_rgba(27,63,104,0.13)]"
                >
                  ...
                  <h3 className="mt-3 break-words text-2xl font-black leading-tight tracking-[-0.03em] text-primary-blue">
                    {item.title}
                  </h3>

                  <p className="mt-4 break-words text-sm font-medium leading-7 text-gray-500">
                    {
                      item.description
                    }
                  </p>
        ...
        <motion.div
          ...
          className="relative z-10 mt-14 min-w-0 overflow-hidden rounded-[34px] bg-primary-blue px-7 py-10 shadow-[0_30px_90px_rgba(27,63,104,0.2)] md:px-10 lg:px-14"
        >
          ...
          <div className="relative z-10 grid min-w-0 gap-8 lg:grid-cols-[1fr_auto] lg:items-center">
            <div className="flex min-w-0 items-start gap-5">
              ...
              <div className="min-w-0">
                <p className="break-words text-xs font-black uppercase tracking-[0.28em] text-primary-red">
                  Technical Assistance
                </p>

                <h3 className="mt-3 max-w-3xl break-words text-3xl font-black leading-tight tracking-[-0.04em] text-white md:text-4xl">
                  Need Help Defining Your Project Requirement?
                </h3>

                <p className="mt-4 max-w-3xl break-words text-base font-medium leading-8 text-white/70">
            ...
            <Link
              ...
              className="group inline-flex min-h-[58px] w-full min-w-0 items-center justify-center gap-3 rounded-2xl bg-primary-red px-8 py-4 text-center font-black !text-white shadow-[0_18px_42px_rgba(194,17,25,0.3)] transition-all duration-300 hover:-translate-y-1 hover:bg-white hover:!text-primary-blue sm:w-auto lg:min-w-[230px]"
            >
