    ...
    <section className="relative overflow-hidden bg-white pb-20 pt-8 lg:pb-28 lg:pt-10">
      <Container>
        <motion.div
          ...
          className="relative isolate overflow-hidden rounded-[40px] bg-primary-blue shadow-[0_40px_105px_rgba(27,63,104,0.23)]"
        >
          {/* Background */}
          ...
          <div className="relative z-10 grid gap-14 px-8 py-14 md:px-10 lg:grid-cols-[1.05fr_0.95fr] lg:items-center lg:px-16 lg:py-20">
            {/* Left content */}
            ...
            <div>
              <div className="inline-flex items-center gap-3 rounded-full border border-white/15 bg-white/10 px-5 py-2.5 backdrop-blur-md">
                <BadgeCheck size={16} className="text-primary-red" />
              ...
              <h2 className="mt-7 max-w-3xl text-4xl font-black leading-[1.02] tracking-[-0.045em] text-white md:text-5xl lg:text-[58px]">
              ...
              <div className="mt-9 flex flex-wrap gap-3">
                {[
                  ...
                  <span
                    key={item}
                    className="inline-flex items-center gap-2 rounded-full border border-white/15 bg-white/10 px-4 py-2.5 text-sm font-black text-white/90 backdrop-blur-md"
                  >
              ...
              <div className="mt-10 flex flex-col gap-4 sm:flex-row sm:flex-wrap">
                <Link
                  href="#quote-form"
                  className="group inline-flex min-h-[60px] items-center justify-center gap-3 rounded-2xl bg-primary-red px-8 py-4 font-black !text-white shadow-[0_18px_42px_rgba(194,17,25,0.3)] transition-all duration-300 hover:-translate-y-1 hover:bg-white hover:!text-primary-blue"
                >
                  Complete Quote Form
                ...
                <Link
                  href="tel:+918130199427"
                  className="group inline-flex min-h-[60px] items-center justify-center gap-3 rounded-2xl border border-white/20 bg-white/10 px-8 py-4 font-black !text-white backdrop-blur-md transition-all duration-300 hover:-translate-y-1 hover:border-white hover:bg-white hover:!text-primary-blue"
                >
                  Call Our Experts
            ...
            <div className="rounded-[32px] border border-white/15 bg-white/10 p-7 shadow-[0_28px_80px_rgba(0,0,0,0.16)] backdrop-blur-xl md:p-8">
                ...
                {contactOptions.map((item) => {
                  ...
                  return (
                    <Link
                      ...
                      className="group flex items-center gap-4 rounded-[22px] border border-white/10 bg-white/[0.08] p-5 !text-white transition-all duration-300 hover:-translate-y-1 hover:border-primary-red/40 hover:bg-white/[0.13]"
                    >
