      ...
      <Container>
        ...
        >
          ...
          <p className="mx-auto mt-6 max-w-3xl text-lg font-medium leading-8 text-gray-600">
            Share the available project details below. More
            information helps our team understand your
            requirements and prepare a more relevant technical
            response.
          </p>
        </motion.div>

        <div className="relative z-10 mt-16 grid gap-10 xl:grid-cols-[1.2fr_0.8fr] xl:items-start">
          {/* Form */}
          ...
          >
            {submitted ? (
              <div className="flex min-h-[700px] items-center justify-center p-8 md:p-12">
                <div className="max-w-xl text-center">
                  ...
                  <p className="mt-5 text-base font-medium leading-8 text-gray-600">
                    Your requirement has been recorded. Our team
                    will review the submitted information before
                    contacting you for the next discussion.
                  </p>
              ...
              <form onSubmit={handleSubmit} noValidate>
                ...
                <div className="border-b border-gray-200 bg-primary-blue px-7 py-8 md:px-10">
                  ...
                  <p className="mt-3 max-w-2xl text-sm font-medium leading-7 text-white/65">
                    ...
                    Other technical details may be shared based
                  ...
                  >
                    <div className="grid gap-7 md:grid-cols-2">
                      ...
                      <RadioGroup
                        ...
                        value={formData.mezzanineRequired}
                        options={[
                          "Yes",
                          "No",
                          "Not Sure",
...
/>
                      ...
                      {!selectedFile ? (
                        ...
                        >
                          ...
                          <p className="mt-2 max-w-md text-sm font-medium leading-6 text-gray-500">
                            PDF, DWG, DXF, ZIP, RAR, JPG or PNG.
  ...
  >
    {fileError || errors.attachment}
                  ...
                  <div className="rounded-[26px] border border-primary-blue/10 bg-[#f8fafc] p-6">
                    <div className="flex items-start gap-3">
                      ...
                      <p className="text-sm font-semibold leading-7 text-gray-600">
                        ...
                        Steelbuild Infra Projects Limited to
                        contact you regarding your project
                        requirement. Your submitted information
                        will be used for quotation and project
                        discussion purposes.
                      </p>
                    </div>
                  </div>
    ...
    <p className="text-sm font-bold leading-7">
      {submissionError}
          ...
          >
            ...
            <div className="overflow-hidden rounded-[34px] border border-gray-200 bg-white shadow-[0_26px_75px_rgba(27,63,104,0.1)]">
              <div className="bg-primary-blue p-7 md:p-8">
                <p className="text-[11px] font-black uppercase tracking-[0.26em] text-primary-red">
                  Why Request a Quote?
                </p>
                ...
                <p className="mt-4 text-sm font-medium leading-7 text-white/65">
                  Every submitted requirement is evaluated
              ...
              <div className="space-y-3 p-6">
                {benefits.map((benefit) => {
                  ...
                  return (
                    <div
                      key={benefit.title}
                      className="group flex gap-4 rounded-[22px] border border-gray-200 bg-[#f8fafc] p-5 transition-all duration-300 hover:-translate-y-1 hover:border-primary-red/20 hover:bg-white hover:shadow-[0_16px_45px_rgba(27,63,104,0.08)]"
                    >
                      ...
                      <div>
                        <h4 className="font-black text-primary-blue">
                          {benefit.title}
                        </h4>
            ...
            <div className="relative isolate overflow-hidden rounded-[34px] bg-primary-blue p-7 shadow-[0_30px_85px_rgba(27,63,104,0.2)] md:p-8">
              ...
              <div className="relative z-10">
                ...
                <p className="mt-4 text-sm font-medium leading-7 text-white/65">
                  Contact our team through phone or email for
                ...
                <div className="mt-7 space-y-3">
                  <Link
                    ...
                    className="group flex items-center gap-4 rounded-2xl border border-white/10 bg-white/[0.08] p-4 !text-white transition-all duration-300 hover:bg-primary-red"
                  >
  ...
  return (
    <section>
      <div className="mb-7 flex items-start gap-4 border-b border-gray-200 pb-6">
        ...
        <div>
          <h4 className="text-xl font-black text-primary-blue">
            {title}
          </h4>
...
function RadioGroup({
  ...
  return (
    <fieldset>
      <legend className="text-sm font-black text-primary-blue">
        {label}
      </legend>
        ...
        {options.map((option) => {
          ...
          return (
            <button
              ...
              className={`min-h-[52px] rounded-2xl border px-4 py-3 text-sm font-black transition-all duration-300 ${
                selected
