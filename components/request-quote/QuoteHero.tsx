    ...
    <section className="relative isolate overflow-hidden bg-white pb-20 pt-28 lg:pb-28 lg:pt-36">
      ...
      <Container>
        ...
        <motion.div
          ...
          className="relative z-10 flex min-w-0 items-center gap-3 text-sm font-semibold text-gray-500"
        >
          <Link
            href="/"
        ...
        {/* Main content */}
        <div className="relative z-10 mt-12 grid min-w-0 gap-12 lg:grid-cols-[0.94fr_1.06fr] lg:items-center">
          {/* Left content */}
          <motion.div
            initial={{
              opacity: 0,
            ...
            className="min-w-0"
          >
            <span className="inline-flex max-w-full items-center gap-3 rounded-full bg-primary-red/10 px-5 py-2.5 text-[11px] font-black uppercase tracking-[0.3em] text-primary-red">
              <BadgeCheck
                size={16}
                className="shrink-0"
              />
            ...
            <h1 className="mt-7 max-w-4xl break-words text-5xl font-black leading-[0.98] tracking-[-0.055em] text-primary-blue md:text-6xl lg:text-[74px]">
              Let&apos;s Build Your
            ...
            <p className="mt-7 max-w-2xl break-words text-lg font-medium leading-9 text-gray-600">
            ...
            <div className="mt-9 flex min-w-0 flex-col gap-4 sm:flex-row sm:flex-wrap">
              <Link
                href="#quote-form"
                className="group inline-flex min-h-[58px] w-full min-w-0 items-center justify-center gap-3 rounded-2xl bg-primary-red px-8 py-4 text-center font-black !text-white shadow-[0_18px_42px_rgba(194,17,25,0.28)] transition-all duration-300 hover:-translate-y-1 hover:bg-primary-blue hover:shadow-[0_24px_55px_rgba(27,63,104,0.2)] sm:w-auto"
              >
                <span className="min-w-0">
                  Submit Requirement
                </span>
              ...
              <Link
                ...
                className="group inline-flex min-h-[58px] w-full min-w-0 items-center justify-center gap-3 rounded-2xl border border-primary-blue/15 bg-white px-8 py-4 text-center font-black !text-primary-blue shadow-[0_16px_42px_rgba(27,63,104,0.08)] transition-all duration-300 hover:-translate-y-1 hover:border-primary-blue hover:bg-primary-blue hover:!text-white sm:w-auto"
              >
                <span className="min-w-0">
                  Call Our Experts
                </span>
            ...
            {/* Trust note */}
            <div className="mt-8 flex min-w-0 max-w-xl items-start gap-3 rounded-[22px] border border-gray-200 bg-white p-5 shadow-[0_14px_40px_rgba(27,63,104,0.06)]">
              <ShieldCheck
                size={23}
                className="mt-0.5 shrink-0 text-primary-red"
              />

              <p className="min-w-0 break-words text-sm font-bold leading-7 text-gray-600">
          ...
          <motion.div
            ...
            className="relative isolate min-w-0 overflow-hidden rounded-[38px] bg-primary-blue p-7 shadow-[0_38px_100px_rgba(27,63,104,0.22)] md:p-9 lg:p-10"
          >
            ...
            <div className="relative z-10 min-w-0">
              <p className="break-words text-[11px] font-black uppercase tracking-[0.28em] text-primary-red">
                What You Can Expect
              </p>

              <h2 className="mt-4 max-w-2xl break-words text-3xl font-black leading-tight tracking-[-0.04em] text-white md:text-4xl">
                Clear Technical Guidance Before Your Project Begins
              </h2>

              <p className="mt-5 max-w-2xl break-words text-base font-medium leading-8 text-white/70">
                ...
                {benefits.map((item, index) => {
                  ...
                  return (
                    <motion.article
                      ...
                      className="group relative min-w-0 overflow-hidden rounded-[24px] border border-white/10 bg-white/[0.08] p-5 backdrop-blur-md transition-all duration-300 hover:-translate-y-1 hover:border-primary-red/45 hover:bg-white/[0.12]"
                    >
                      ...
                      <h3 className="mt-5 break-words text-lg font-black leading-tight text-white">
                        {item.title}
                      </h3>

                      <p className="mt-3 break-words text-sm font-medium leading-7 text-white/60">
                        {item.description}
                      </p>
                    </motion.article>
                  );
        ...
        <motion.div
          ...
          className="relative z-10 mt-12 grid min-w-0 overflow-hidden rounded-[30px] border border-gray-200 bg-white shadow-[0_24px_75px_rgba(27,63,104,0.1)] sm:grid-cols-2 lg:grid-cols-4"
        >
          {stats.map((stat, index) => {
            ...
            return (
              <div
                key={stat.label}
                className={`group flex min-h-[122px] min-w-0 items-center gap-4 px-6 py-6 transition-colors duration-300 hover:bg-[#f8fafc] ${
              ...
              >
                ...
                <div className="min-w-0">
                  <p className="break-words text-2xl font-black tracking-[-0.04em] text-primary-blue md:text-3xl">
                    {stat.value}
                  </p>
