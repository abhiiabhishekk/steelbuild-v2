...
const processSteps = [
  {
    ...
    description:
      "Reviewing floor layout, building usage, structural grid, design loads, floor openings and project requirements.",
  },
  {
    number: "02",
    icon: FileText,
    title: "Composite Floor Engineering",
    description:
      "Developing the deck profile, sheet thickness, slab depth, reinforcement and composite floor arrangement.",
  },
  {
    number: "03",
    icon: Building2,
    ...
    description:
      "Coordinating deck spans, primary beams, secondary beams, columns, edge members and floor openings.",
  },
  {
    number: "04",
    icon: Factory,
    title: "Deck Sheet Manufacturing",
    description:
      "Precision roll-forming deck sheets from approved coated steel material according to production requirements.",
  },
  {
    number: "05",
    icon: ShieldCheck,
    ...
    description:
      "Checking profile geometry, dimensions, sheet thickness, coating condition and finished production quality.",
  },
  {
    number: "06",
    icon: Truck,
    ...
    description:
      "Organizing completed deck sheets for safe packing, identification, transportation and site delivery.",
  },
  {
    number: "07",
    icon: Wrench,
    title: "Deck Sheet Installation",
    description:
      "Installing deck sheets across approved supporting beams with correct bearing, overlap and edge detailing.",
  },
  {
    number: "08",
    icon: Layers3,
    title: "Concrete Slab Completion",
    description:
      "Coordinating reinforcement, shear connectors, concrete placement, finishing and final composite floor inspection.",
  },
];

export default function DeckSheetsProcess() {
  return (
      ...
      <Container>
        ...
        >
          ...
          <h2 className="mt-7 text-4xl font-black leading-tight tracking-[-0.045em] text-primary-blue md:text-5xl lg:text-[58px]">
            From Composite Floor Engineering to Final Slab Completion
          </h2>

          <p className="mx-auto mt-6 max-w-3xl text-lg font-medium leading-8 text-gray-600">
            Every deck-sheet project follows a coordinated process covering
            structural engineering, production, installation, reinforcement
            and concrete slab completion.
          </p>
        </motion.div>
  ...
  <div className="relative z-10 flex flex-col gap-5 md:flex-row md:items-center">
    ...
    <div>
      <h3 className="text-2xl font-black text-white">
        Engineering Coordination Ensures Composite Floor Performance
      </h3>

      <p className="mt-2 text-sm font-medium leading-7 text-white/70">
        Deck-sheet profile, structural framing, reinforcement, shear
        connectors, concrete slab design and installation sequencing are
        coordinated according to approved engineering drawings and project
        requirements.
      </p>
    </div>
  </div>
