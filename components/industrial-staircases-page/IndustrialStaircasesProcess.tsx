...
export default function IndustrialStaircasesProcess() {
  return (
      ...
      <Container>
        ...
        >
          <span className="inline-flex items-center gap-2 rounded-full bg-primary-red/10 px-6 py-2 text-xs font-black uppercase tracking-[0.3em] text-primary-red">
            <Wrench size={15} />
            Industrial Staircase Development Process
          </span>

          <h2 className="mt-7 text-4xl font-black leading-tight tracking-[-0.045em] text-primary-blue md:text-5xl lg:text-[58px]">
            From Engineering Planning to Final Installation
          </h2>

          <p className="mx-auto mt-6 max-w-3xl text-lg font-medium leading-8 text-gray-600">
            Every industrial steel staircase is developed through a coordinated
            process covering planning, structural design, fabrication,
            finishing and installation according to approved project
            requirements.
          </p>
        </motion.div>
          ...
          <div className="relative z-10 flex flex-col gap-5 md:flex-row md:items-center">
            ...
            <div>
              ...
              <p className="mt-2 text-sm font-medium leading-7 text-white/70">
                Final staircase geometry, member sizes, connections, coatings,
                landings and protection details are developed according to
