...
const projectInputs = [
  {
    ...
    text: "Dimensions, storage zones and insulated-envelope requirements",
  },
  {
    icon: Truck,
    title: "Operational Movement",
    text: "Loading, unloading, access and internal circulation",
  },
  {
    icon: FileText,
    title: "Project Information",
    text: "Location, approved layout and expected timeline",
  },
];
    ...
    <section className="relative overflow-hidden bg-white py-24 lg:py-32">
      ...
      <Container>
        ...
        >
          ...
          <div className="pointer-events-none absolute inset-0 bg-[linear-gradient(125deg,#153b68_0%,#286295_48%,#113158_100%)]" />
          ...
          <div className="pointer-events-none absolute -bottom-28 -right-20 h-96 w-96 rounded-full bg-white/10 blur-[110px]" />

          <div className="relative z-10 grid gap-12 px-8 py-12 md:px-12 md:py-16 lg:grid-cols-[1.05fr_0.95fr] lg:items-center lg:px-16 lg:py-20">
            {/* Left content */}
            ...
            <div>
              <span className="inline-flex items-center gap-2 rounded-full border border-white/15 bg-white/10 px-5 py-2.5 text-[11px] font-black uppercase tracking-[0.26em] text-white backdrop-blur-md">
                ...
                />
                Start Your Cold Storage Project
              </span>
              ...
              <p className="mt-6 max-w-2xl text-base font-medium leading-8 text-white/70 md:text-lg">
                Share your building dimensions, storage layout, access,
                insulated-envelope requirements and project location with our
            ...
            <div className="rounded-[32px] border border-white/12 bg-white/[0.08] p-7 backdrop-blur-md md:p-8">
              ...
              <h3 className="mt-4 text-3xl font-black leading-tight tracking-[-0.04em] text-white">
                Share the Basics to Start the Discussion
              </h3>
              ...
              <div className="mt-8 flex items-start gap-3 rounded-[22px] bg-[#102f55] p-5">
                ...
                <p className="text-sm font-black leading-7 text-white/80">
                  Final building systems and specialist services are developed
                  according to approved project requirements and responsible
                  technical inputs.
                </p>
              </div>
            </div>
