...
const warehouseHighlights = [
  {
    icon: Boxes,
    title: "Efficient Storage Planning",
    description:
      "Clear internal spaces coordinated around racking, stacking, inventory movement and material-handling requirements.",
  },
  {
    icon: Truck,
    title: "Loading & Dispatch Access",
    description:
      "Vehicle movement, loading bays, dock positions and dispatch zones planned around daily logistics operations.",
  },
  {
    icon: ShieldCheck,
    title: "Reliable Building Protection",
    description:
      "Structural framing, roofing, cladding, drainage and ventilation systems coordinated for dependable storage conditions.",
  },
];
...
const quickHighlights = [
  {
    ...
    text: "Planned around inventory and racking",
  },
  {
    icon: Truck,
    title: "Logistics Integration",
    text: "Vehicle, loading and dispatch coordination",
  },
  {
    icon: PackageCheck,
  ...
  return (
    <section className="relative isolate overflow-hidden bg-white pb-20 pt-28 lg:pb-28 lg:pt-36">
      ...
      <Container>
        ...
        <div className="relative z-10 mt-12 grid gap-12 lg:grid-cols-[0.98fr_1.02fr] lg:items-center">
          {/* Left content */}
          ...
          >
            ...
            <p className="mt-7 max-w-2xl text-lg font-medium leading-9 text-gray-600">
              Steelbuild Infra Projects Limited delivers engineered warehouse
              buildings designed for efficient storage, organized inventory,
              faster material movement, loading operations and future
              expansion.
            </p>
            ...
            <div className="mt-8 flex max-w-xl items-start gap-4 rounded-[22px] border border-gray-200 bg-white p-5 shadow-[0_14px_40px_rgba(27,63,104,0.07)]">
              ...
              <p className="pt-0.5 text-sm font-bold leading-7 text-gray-600">
                ...
                execution for storage, logistics and distribution requirements.
              </p>
            </div>
          </motion.div>

          {/* Right warehouse operations panel */}
            ...
            <div className="relative z-10">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <h2 className="mt-2 text-3xl font-black leading-tight text-white">
                    Built Around Warehouse Operations
                  </h2>
                </div>
              </div>

              <p className="mt-6 text-base font-medium leading-8 text-white/70">
                Warehouse buildings coordinate storage height, racking,
                circulation, vehicle access, loading zones and building systems
                into one efficient operational facility.
              </p>

              <div className="mt-8 space-y-4">
                {warehouseHighlights.map((item, index) => {
              ...
              <div className="mt-7 flex items-start gap-3 rounded-[22px] border border-white/10 bg-[#102f55] p-5">
                ...
                <p className="text-sm font-black leading-7 text-white/80">
                  Suitable for distribution centres, logistics hubs, storage
                  facilities, fulfilment centres and industrial warehousing.
                </p>
              </div>
            </div>
          </motion.div>
        ...
        {/* Warehouse workflow strip */}

        <motion.div
          initial={{ opacity: 0, y: 26 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.6, delay: 0.2 }}
          className="relative z-10 mt-14 overflow-hidden rounded-[30px] border border-gray-200 bg-white shadow-[0_20px_65px_rgba(27,63,104,0.08)]"
        >
