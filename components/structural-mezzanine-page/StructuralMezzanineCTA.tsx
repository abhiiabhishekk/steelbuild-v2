...
const projectInputs = [
  {
    icon: Ruler,
    title: "Available Building Space",
    text: "Floor area, clear height, proposed footprint and site conditions",
  },
  {
    icon: Layers3,
    title: "Intended Mezzanine Use",
    text: "Storage, production support, offices or other operational requirements",
  },
  {
    icon: FileText,
    title: "Project Information",
    text: "Approved loading, drawings, access requirements and project timeline",
  },
];

export default function StructuralMezzanineCTA() {
  return (
          ...
          <div className="relative z-10 grid gap-12 px-8 py-12 md:px-12 md:py-16 lg:grid-cols-[1.06fr_0.94fr] lg:items-center lg:px-16 lg:py-20">
            ...
            <div>
              ...
              <p className="mt-6 max-w-2xl text-base font-medium leading-8 text-white/70 md:text-lg">
                Share your available building space, intended mezzanine use,
                approved loading, access requirements and project details with
                our engineering team for a coordinated technical discussion.
              </p>
            ...
            <div className="rounded-[32px] border border-white/15 bg-white/[0.08] p-7 backdrop-blur-md md:p-8">
              ...
              <div className="mt-8 flex items-start gap-3 rounded-[22px] bg-[#102f55] p-5">
                ...
                <p className="text-sm font-black leading-7 text-white/80">
                  Final member sizes, floor system, connections, staircases and
                  perimeter-protection details are developed according to
