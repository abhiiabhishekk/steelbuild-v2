    ...
    <section className="relative overflow-hidden bg-white py-16 sm:py-20 lg:py-32">
      ...
      <Container>
        ...
        >
          ...
          <h2 className="mt-6 text-[34px] font-black leading-[1.08] tracking-[-0.04em] text-primary-blue sm:mt-7 sm:text-5xl lg:text-[58px]">
              ...
              <div className="flex items-start gap-3.5 sm:gap-4">
                ...
                <div className="min-w-0">
                  ...
                  <p className="mt-1.5 text-[14px] font-black leading-[1.45] tracking-[-0.01em] text-primary-blue sm:mt-2 sm:text-base sm:leading-6">
                    Double metal skins permanently bonded to a continuous
                    insulation core create one factory-engineered insulated
                    panel, providing thermal efficiency, weather protection and
        ...
        >
          ...
          <p className="text-[13px] font-bold leading-6 text-primary-blue sm:text-sm sm:leading-7">
            Sandwich panel thickness, external and internal metal-skin
            specification, PIR, PUF or Rockwool insulation-core selection,
            joint geometry, fastening arrangement, flashing details and
            supporting wall-girt or roof-purlin layouts are engineered
            according to thermal, structural, acoustic, fire-performance and
