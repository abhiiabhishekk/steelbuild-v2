...
const processSteps = [
  {
    ...
    description:
      "Building use, thermal targets, acoustic requirements, fire-performance criteria and project conditions are reviewed.",
    icon: ClipboardCheck,
  },
  {
    number: "02",
    title: "Panel System Engineering",
    description:
      "Panel thickness, metal-skin specification, PIR, PUF or Rockwool core, joint type, support layout and flashings are finalized.",
  ...
  },
  {
    ...
    description:
      "Outer and inner metal skins are roll-formed, combined with the approved insulation core and bonded into one continuous panel.",
    icon: Factory,
  },
  {
    number: "04",
    ...
    description:
      "Panel dimensions, skin bonding, insulation continuity, joint geometry, coating condition and surface finish are inspected.",
    icon: SearchCheck,
  },
  {
    number: "05",
    ...
    description:
      "Finished sandwich panels are protected, stacked, identified and prepared for safe transportation to the project site.",
    icon: Truck,
  },
  {
    number: "06",
    ...
    description:
      "Wall girts, roof purlins, openings, flashing interfaces and panel installation sequence are coordinated with approved drawings.",
    icon: Layers3,
  },
  {
    number: "07",
    ...
    description:
      "Panels, joints, fasteners, flashings, trims and sealing systems are installed according to approved engineering details.",
    icon: Wrench,
  },
  {
    number: "08",
    ...
    description:
      "Panel alignment, joint continuity, weatherproofing, insulation integrity and finished envelope performance are verified.",
    icon: BadgeCheck,
  },
];

export default function SandwichPanelsProcess() {
  return (
      ...
      <Container>
        ...
        >
          <span className="inline-flex items-center gap-2 rounded-full bg-primary-red/10 px-6 py-2 text-xs font-black uppercase tracking-[0.3em] text-primary-red">
            <BadgeCheck size={15} />
            Sandwich Panel Process
          </span>

          <h2 className="mt-7 text-4xl font-black leading-tight tracking-[-0.045em] text-primary-blue md:text-5xl lg:text-[58px]">
            From Panel Engineering
            <span className="block">
              to Final Envelope Installation
            </span>
          </h2>

          <p className="mx-auto mt-6 max-w-3xl text-lg font-medium leading-8 text-gray-600">
            Every sandwich-panel project follows a coordinated process
            covering panel engineering, insulated-core selection,
            manufacturing, quality control, installation and final handover.
          </p>
        </motion.div>
  ...
  <div className="relative z-10 flex flex-col gap-5 md:flex-row md:items-center">
    ...
    <div>
      ...
      <p className="mt-2 text-sm font-medium leading-7 text-white/70">
        Panel thickness, outer and inner metal-skin specification, insulation
        core type, joint geometry, fastening system, flashing details and
        installation sequence are finalized according to approved drawings
        and project-performance requirements.
      </p>
    </div>
  </div>
</motion.div>
