...
const projectInputs = [
  {
    ...
    text: "Building dimensions, roof geometry and intended building application.",
  },
  {
    icon: PanelsTopLeft,
    title: "Roofing Requirements",
    text: "Preferred roofing system, accessories and ventilation requirements.",
  },
  {
    icon: FileText,
    title: "Project Documents",
    text: "Drawings, specifications, site conditions and project schedule.",
  },
];
    ...
    <section className="relative overflow-hidden bg-white py-24 lg:py-32">
      ...
      <Container>
        <motion.div
          ...
          className="relative isolate overflow-hidden rounded-[42px] bg-primary-blue shadow-[0_40px_110px_rgba(27,63,104,0.24)]"
        >
          {/* Background */}
          ...
          <div className="relative z-10 grid gap-12 px-8 py-12 md:px-12 md:py-16 lg:grid-cols-[1.06fr_0.94fr] lg:items-center lg:px-16 lg:py-20">
            ...
            <div>
              ...
              <h2 className="mt-7 text-4xl font-black leading-[1.02] tracking-[-0.045em] text-white md:text-5xl lg:text-[58px]">
                Planning an
              ...
              <p className="mt-6 max-w-2xl text-base font-medium leading-8 text-white/70 md:text-lg">
                Share your building details, roof geometry, drawings and
                project requirements with our engineering team for a technical
                discussion on suitable roofing solutions.
              </p>
            ...
            <div className="rounded-[32px] border border-white/15 bg-white/[0.08] p-7 backdrop-blur-md md:p-8">
              ...
              <div className="mt-8 flex items-start gap-3 rounded-[22px] bg-[#102f55] p-5">
                ...
                <p className="text-sm font-black leading-7 text-white/80">
                  Final roofing materials, accessories and installation details
                  are developed according to approved engineering drawings and
