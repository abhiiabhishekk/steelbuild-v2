...
const processSteps = [
  {
    ...
    description:
      "Understanding factory usage, machinery layout, clear height, access, utilities and project location.",
  },
  {
    number: "02",
    icon: Ruler,
    ...
    description:
      "Planning the structural grid around production flow, working zones and internal movement.",
  },
  {
    number: "03",
    icon: ShieldCheck,
    ...
    description:
      "Developing the structural system, member design, bracing and coordinated project drawings.",
  },
  {
    number: "04",
    icon: Factory,
    ...
    description:
      "Manufacturing structural components through planned cutting, welding, drilling and finishing processes.",
  },
  {
    number: "05",
    icon: Truck,
    ...
    description:
      "Dispatching components in sequence and installing the structural frame and building envelope at site.",
  },
  {
    number: "06",
    icon: CheckCircle2,
    ...
    description:
      "Completing final checks, resolving observations and handing over the finished building system.",
  },
];
      ...
      <Container>
        ...
        >
          <span className="inline-flex items-center gap-2 rounded-full bg-primary-red/10 px-6 py-2 text-xs font-black uppercase tracking-[0.3em] text-primary-red">
            <Wrench size={15} />
            Factory Project Process
          </span>

          <h2 className="mt-7 text-4xl font-black leading-tight tracking-[-0.045em] text-primary-blue md:text-5xl lg:text-[58px]">
            A Coordinated Process From Planning to Handover
          </h2>

          <p className="mx-auto mt-6 max-w-3xl text-lg font-medium leading-8 text-gray-600">
            Factory building delivery connects operational planning,
            structural engineering, manufacturing and site execution through
            one organized workflow.
          </p>
        </motion.div>

        {/* Desktop production-line flow */}
          ...
          <div className="relative z-10 flex flex-col gap-5 md:flex-row md:items-center">
            ...
            <div>
              <h3 className="text-2xl font-black text-white">
                Project Requirements Guide Every Stage
              </h3>

              <p className="mt-2 text-sm font-medium leading-7 text-white/70">
                Final engineering, fabrication and execution details are
                developed according to the approved project requirements,
