...
const projectInputs = [
  {
    ...
    text: "Dimensions, clear height and project location",
  },
  {
    icon: Workflow,
    title: "Operational Layout",
    text: "Production flow, machinery and access needs",
  },
  {
    icon: FileText,
    title: "Project Timeline",
    text: "Expected schedule and expansion plans",
  },
];
  ...
  return (
    <section className="relative overflow-hidden bg-white py-24 lg:py-32">
      ...
      <Container>
        ...
        >
          <div className="pointer-events-none absolute inset-0 bg-[linear-gradient(125deg,#153b68_0%,#23578d_48%,#113158_100%)]" />
          ...
          <div className="relative z-10 grid gap-12 px-8 py-12 md:px-12 md:py-16 lg:grid-cols-[1.05fr_0.95fr] lg:items-center lg:px-16 lg:py-20">
            ...
            <div>
              ...
              <p className="mt-6 max-w-2xl text-base font-medium leading-8 text-white/70 md:text-lg">
                Share your building dimensions, production requirements,
                machinery layout and project location with our team for a
            ...
            <div className="rounded-[32px] border border-white/12 bg-white/[0.08] p-7 backdrop-blur-md md:p-8">
              ...
              <div className="mt-8 flex items-start gap-3 rounded-[22px] bg-[#102f55] p-5">
                ...
                <p className="text-sm font-black leading-7 text-white/80">
                  Final planning and engineering are developed according to
                  approved project requirements and site conditions.
                </p>
              </div>
            </div>
          </div>
