...
export default function MultiStoreyProcess() {
  return (
      ...
      <Container>
        ...
        >
          ...
          <h2 className="mt-7 text-4xl font-black leading-tight tracking-[-0.045em] text-primary-blue md:text-5xl lg:text-[58px]">
            Our End-to-End Multi-Storey Building Delivery Process
          </h2>

          <p className="mx-auto mt-6 max-w-3xl text-lg font-medium leading-8 text-gray-600">
            Every multi-storey steel building is engineered, manufactured and
            delivered through a structured execution process focused on
            coordination, quality, safety and timely completion.
          </p>
        </motion.div>
          ...
          <div className="relative z-10 grid gap-10 lg:grid-cols-[0.86fr_1.14fr] lg:items-center">
            <div>
              ...
              <h3 className="mt-4 text-3xl font-black leading-tight tracking-[-0.04em] text-white md:text-4xl">
                From Initial Requirements to Final Building Handover
              </h3>

              <p className="mt-5 text-base font-medium leading-8 text-white/70">
                Steelbuild coordinates engineering, fabrication, quality,
                logistics and erection through one integrated project-delivery
                system.
              </p>
            </div>
