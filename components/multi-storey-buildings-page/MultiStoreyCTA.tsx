...
export default function MultiStoreyCTA() {
  return (
          ...
          <div className="relative z-10 grid gap-12 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
            ...
            <div>
              ...
              <p className="mt-6 max-w-2xl text-base font-medium leading-8 text-white/70">
                Share your floor requirements, building usage, structural
                loads, project location, access requirements and expected
                timeline with our team for a coordinated technical and
            ...
            <div className="grid gap-5">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="text-xl font-black text-white">
                      Share Building Requirements
                    </h3>

                    <p className="mt-2 text-sm font-medium leading-7 text-white/60">
                      Provide the number of floors, floor usage, building
                      dimensions, clear heights, loading requirements and
                      project location.
                    </p>
                  </div>
                </div>
              ...
              <div className="rounded-[26px] border border-white/10 bg-white/[0.08] p-6 backdrop-blur-md">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="text-xl font-black text-white">
                      Floor & Structural Planning
                    </h3>

                    <p className="mt-2 text-sm font-medium leading-7 text-white/60">
                      Our team reviews structural grids, floor systems,
                      staircases, circulation, services and future expansion
                      requirements.
                    </p>
                  </div>
                </div>
              ...
              <div className="rounded-[26px] border border-white/10 bg-white/[0.08] p-6 backdrop-blur-md">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="mt-2 text-sm font-medium leading-7 text-white/60">
                      Discuss building usage, operational loads, access,
                      equipment, utilities, project execution and delivery
                      requirements.
                    </p>
                  </div>
                </div>
              ...
              <div className="flex items-start gap-4 rounded-[26px] border border-white/10 bg-[#0b2b50]/70 p-6">
                ...
                <div>
                  ...
                  <p className="mt-2 text-sm font-medium leading-7 text-white/60">
                    Engineering, fabrication, quality inspection, dispatch
                    coordination and site execution through one integrated
