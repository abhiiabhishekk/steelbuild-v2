...
export default function CorporateProfileCTA() {
  return (
      ...
      <Container>
        ...
        >
          ...
          <h2 className="mt-8 text-4xl font-black leading-tight tracking-[-0.045em] text-white md:text-5xl lg:text-6xl">
            Have an Upcoming Industrial
            <span className="block">Building Project?</span>
          </h2>

          <p className="mx-auto mt-8 max-w-3xl text-lg font-medium leading-9 text-white/75">
            Connect with our team for project consultation, technical
            discussions, budgetary proposals and dependable Pre-Engineered
            Building solutions.
          </p>
            ...
            <div className="flex flex-col items-center gap-5 md:flex-row">
              ...
              <div>
                ...
                <h3 className="mt-2 text-2xl font-black text-white">
                  Speak with Our Engineering and Business Team
                </h3>

                <p className="mt-2 max-w-2xl text-sm font-medium leading-7 text-white/75">
                  Share your project requirements for technical consultation,
                  quotations and commercial discussions.
                </p>
              </div>
            </div>
