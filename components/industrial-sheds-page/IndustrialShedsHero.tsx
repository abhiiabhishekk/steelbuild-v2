...
const highlights = [
  {
    icon: Ruler,
    title: "Flexible Clear Spans",
    description:
      "Industrial shed layouts planned around production flow, equipment placement, storage and operational movement.",
  },
  {
    icon: Factory,
    title: "Efficient Fabrication",
    description:
      "Primary and secondary steel components manufactured through controlled factory processes for consistency and speed.",
  },
  {
    icon: ShieldCheck,
    title: "Reliable Performance",
    description:
      "Structural framing, bracing, roofing and cladding coordinated for safe and dependable industrial use.",
  },
];

export default function IndustrialShedsHero() {
  return (
        ...
        <div className="relative z-10 mt-12 grid gap-12 lg:grid-cols-[1.03fr_0.97fr] lg:items-center">
          ...
          >
            ...
            <p className="mt-7 max-w-2xl text-lg font-medium leading-9 text-gray-600">
              Steelbuild Infra Projects Limited delivers engineered industrial
              sheds designed for manufacturing, assembly, storage, processing
              and operational facilities requiring efficient space, faster
              construction and reliable structural performance.
            </p>

            <div className="mt-9 flex flex-col gap-4 sm:flex-row sm:flex-wrap">
              <Link
                href="#industrial-sheds-overview"
            ...
            <div className="mt-8 flex max-w-xl items-start gap-4 rounded-[22px] border border-gray-200 bg-white p-5 shadow-[0_14px_40px_rgba(27,63,104,0.07)]">
              ...
              <p className="pt-0.5 text-sm font-bold leading-7 text-gray-600">
                Integrated design, fabrication and project execution for
                industrial shed requirements across manufacturing, storage and
            ...
            <div className="relative z-10">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <h2 className="mt-2 text-3xl font-black leading-tight text-white">
                    Structured for Efficient Operations
                  </h2>
                </div>
              </div>

              <p className="mt-6 text-base font-medium leading-8 text-white/70">
                Industrial sheds combine structural steel framing, roofing,
                cladding, ventilation, access and service coordination into one
              ...
              <div className="mt-7 flex items-start gap-3 rounded-[22px] border border-white/10 bg-[#102f55] p-5">
                ...
                <p className="text-sm font-black leading-7 text-white/80">
                  Suitable for manufacturing, assembly, fabrication,
                  processing, repair, storage and general industrial
                  operations.
                </p>
              </div>
            </div>
        ...
        >
          <div className="flex items-center gap-4 border-b border-gray-200 p-6 md:border-b-0 md:border-r">
            ...
            <div>
              <p className="text-sm font-black text-primary-blue">
                Flexible Shed Layouts
              </p>

              <p className="mt-1 text-xs font-medium text-gray-500">
                Planned around industrial operations
              </p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-4 border-b border-gray-200 p-6 md:border-b-0 md:border-r">
            ...
            <div>
              ...
              <p className="mt-1 text-xs font-medium text-gray-500">
                Accurate structural manufacturing
              </p>
            </div>
          </div>
